"""First-run walkthrough for GestureOS."""
...
class OnboardingDialog(QDialog):
    ...
    PAGES = (
        ("Welcome to GestureOS", "Control media naturally with hand gestures and motion—without touching your keyboard."),
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.setWindowTitle("Welcome to GestureOS")
        self.setModal(True)
